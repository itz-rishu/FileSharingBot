...
async def batch(client: Client, message: Message):
    ...
    while True:
        ...
        if s_msg_id:
            ...
            await second_message.reply("❌ <b>ᴇʀʀᴏʀ</b>\n\nᴛʜɪs ғᴏʀᴡᴀʀᴅᴇᴅ ᴘᴏsᴛ ɪs ɴᴏᴛ ғʀᴏᴍ ᴍʏ ᴅʙ ᴄʜᴀɴɴᴇʟ ᴏʀ ᴛʜɪs ʟɪɴᴋ ɪs ᴛᴀᴋᴇɴ ғʀᴏᴍ ᴅʙ ᴄʜᴀɴɴᴇʟ", quote = True)
            continue
    ...
    await second_message.reply_text(f"<b>ʜᴇʀᴇ ɪs ʏᴏᴜʀ ʟɪɴᴋ</b>\n\n{link}\n\n<b>ᴍᴀᴅᴇ ᴡɪᴛʜ ❤ ʙʏ <a href="https://t.me/BT46ER">˹ʀɪsʜᴜ˼🥀</a></b>", quote=True, reply_markup=reply_markup)
